...
include_once(LOGINIZER_DIR .'/common.php');
...
function lz_report_error($error = array()){
	...
	$error_string = '<b>'.__('Please fix the below error(s)', 'loginizer').' :</b> <br />';
...
function lz_report_notice($notice = array()){
	...
	$notice_string = '<b>'.__('Please check the below notice(s)', 'loginizer').' :</b> <br />';
